...
## 版本说明
### V1.0.8
* 新增目录辅助类 DirHelper，支持路径按层级拆分
* 新增 TargetPathCompare 去重比较器，解决目标路径重复问题
* 增强"忽略当前文件夹"功能，支持多级目录选择
* 重构右键选中逻辑，支持 Ctrl 键多选
* 修复 BoolToVisibilityConverter 不支持参数反转的问题
* 优化文件添加逻辑，支持目录结构添加和 SubPath 修复
* 优化 TargetPath 变更确认逻辑，单文件不再弹确认框
* 修改本地目标文件读取逻辑，从"获取已包含的"改为"获取未包含的"
